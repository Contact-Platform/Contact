...
typedef struct MESSAGE_TYPE {
  // TODO - Crear Arrays individuales para cada valor
  int  packetId;  
  char TxID[12];
  char RxID[12];
  char data[DATA_SIZE];
...
void setup()
{
 ...
 // Get the CONTACT vars Settings from RAM (EEPROM).
    ...
    if (paramsNmbr > 0) {
       ...
       jsonData += ("\"unit\":\"" + String(CONTACTvars.unitName) + "\",");
