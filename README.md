...
![Contac Capacities](/Platform/images/contact-capacities.png)
...
Beacause the Contact Unit is based on the Arduino open architecture we prepare it to use a small GPS module to offer more scalability (the recommended GPS module size is 0.4 x 0.4 inches).
```cpp
/********** GPS UNIT SETTINGS *************/
#include <TinyGPS++.h>
